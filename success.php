            ...
            <div class="profile-header">
                <div class="cover">
                    ...
                    <div class="cover-body d-flex justify-content-between align-items-center">
                        <div>
                            <img class="profile-pic" src="gembong.jpg" alt="profile">
                            <span class="profile-name">ADIB MUZAKKI</span>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12 grid-margin">
                    <div class="card rounded">
                        ...
                        <div class="card-body">
                            <p class="mb-3 tx-14">Profil Biodata Agos Kotak Atau Ega Al Fariz Yang Lagi Trending Di Youtubea</p>
                            <img class="img-fluid" src="agos.jpeg" alt="">
                        </div>
